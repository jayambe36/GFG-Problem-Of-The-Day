<h2><a href="https://www.geeksforgeeks.org/problems/swap-two-numbers3844/1?page=1&company=Google,Samsung,Facebook,Atlassian,IBM,Philips,HCL,Intel&difficulty=School&sortBy=submissions">Swap two numbers</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 20px;">Swap given two numbers and print them. (Try to do it without a temporary variable.) and return it.</span></p>
