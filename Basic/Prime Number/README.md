<h2><a href="https://www.geeksforgeeks.org/problems/prime-number2314/1?page=1&company=Amazon,Google,Samsung,Facebook,Atlassian,IBM,Philips,HCL,Intel,Zomato&difficulty=Basic&sortBy=submissions">Prime Number</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">For a given number <strong>N</strong> check if it is prime or not. A prime number is a number which is only<strong> divisible by 1 and itself</strong>.</span><br>
&nbsp;</p>
